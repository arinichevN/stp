...
function build_lib {
	...
	gcc $1  -c green_light.c -D_REENTRANT $DEBUG_PARAM && \
    if [ ! -f ../sqlite3.o ]; then
	...
	rm -f libpac.a
	ar -crv libpac.a app.o crc.o dbl.o timef.o udp.o util.o tsv.o configl.o green_light.o ../sqlite3.o acp/main.o && echo "library: done"
}
